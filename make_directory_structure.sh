...
dim={002,003,005,010,020,050,100}/seed={000..29}/all_components/eval_lp/no_non_edges/\
{no_attributes,multiply_attributes,jump_prob={0.05,0.1,0.2}}

mkdir -p walks/{cora_ml,citeseer,pubmed,cora}/\
seed={000..29}/all_components/eval_lp/no_non_edges/\
{no_attributes,multiply_attributes,jump_prob={0.05,0.1,0.2}}

mkdir -p test_results/{cora_ml,citeseer,pubmed,cora}/\
dim={002,003,005,010,020,050,100}/all_components/eval_lp/no_non_edges/\
{no_attributes,multiply_attributes,jump_prob={0.05,0.1,0.2}}
